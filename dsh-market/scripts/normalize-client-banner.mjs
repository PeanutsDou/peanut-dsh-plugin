 ...
 * sniff the loader id from the file head) requires client/client.js to START
 * with the exact one-line `window.__ModuleLoader__.load({ id: "<name>"`
 * prefix. Collapse the header onto one line, leaving blank lines in place of
 * the folded ones so the sourcemap's line numbers stay valid.
 */
