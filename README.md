...
| [dsh-session-notification](dsh-session-notification) | 会话完成/失败/提问/权限请求四种状态通知：提示音 + 浏览器系统通知，设置页可自定义音效（上游 [dingyi222666/dsh-session-notification](https://github.com/dingyi222666/dsh-session-notification)，v0.1.2 / `91e386d`） | ✅ 可用 |
...
| [dsh-synapse](dsh-synapse) | DSH 可视化会话地图：拖拽/缩放/分支/详情投影（上游 [liangmianya/dsh-synapse](https://github.com/liangmianya/dsh-synapse)，v0.3.0 / `a323f76`） | ❌ 已卸载（2026-08-30，prod + staging；保留源码仅作「对话 / xxx」页签交互参考） |
