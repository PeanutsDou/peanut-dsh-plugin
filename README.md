...
| [dsh-notification](dsh-notification) | 任务完成通知：会话结束自动弹浏览器系统通知，带最近一轮摘要，支持关键词/状态过滤（上游 [omdsh-dev/dsh-notification](https://github.com/omdsh-dev/dsh-notification)，v0.1.3） | ✅ 可用 |
